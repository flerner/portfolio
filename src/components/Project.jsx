        ...
        <div class="max-w-sm bg-slate-900 border border-[#d9ff54] rounded-lg shadow ">
            ...
            <div class="p-5">
                ...
                <div className="flex justify-between">
                    <a href="https://netflix-clone-gules-psi.vercel.app/" target="_blank" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-black bg-[#9fbd39] rounded-lg hover:bg-[#7d952f] focus:ring-4 focus:outline-none focus:ring-blue-300 ">
                        Visit
