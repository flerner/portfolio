...
function MobileNavBar({ onSelectOption }) {
    ...
    return (
        <div className="fixed top-0 left-0 h-full">
            ...
            {menuClicked &&
                <div className='md:hidden  text-white flex flex-col pt-16 bg-black h-full opacity-80 transition-all duration-800'>
                    ...
                    <button onClick={() => handleClick(NavOptions.WorkExperienceSection)} className=" text-white hover:border hover:border-white focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-8 text-center me-2 mb-2">Experience/Education</button>
                </div>
            }
        </div>
