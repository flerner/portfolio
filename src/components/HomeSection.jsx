    ...
    return (
        <div className="flex items-center justify-between h-screen">
            <div className="flex flex-col justify-center md:ml-24 text-white ">
                ...
                <p className="my-8 max-w-96 ml-1">I'm a Full Stack Developer based in Argentina. Welcome to my portfolio, where you can explore my skills, experiences, and projects.</p>
