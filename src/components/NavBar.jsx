    ...
    return (
        <div>
            <div className="flex flex-col mx-auto bg-gray-200">
                <aside className="group/sidebar flex flex-col items-center shrink-0 md:w-[320px] w-[288px] transition-all duration-300 ease-in-out m-0 fixed z-40 inset-y-0 left-0 bg-gradient-to-b from-zinc-950 to-gray-950 border-r border-r-dashed border-r-neutral-200 sidenav fixed-start loopple-fixed-start">
